...
public final class Options {
  ...
  int getLedOn() {
    ...
    if (cfg instanceof JSONArray) return options
      .optJSONArray("led")
      .optInt(1, defVal);

    if (cfg instanceof JSONObject) return options
      .optJSONObject("led")
      .optInt("on", defVal);
  ...
  Message[] getMessages() {
    ...
    if (text == null || text instanceof String) return null;
